...
from dst.attendance_views import (
    AttendanceCheckinDataView,
    AttendanceCheckinView,
    AttendanceCodesView,
    AttendanceCreatePersonWeekView,
    AttendanceDeletePersonWeekView,
    AttendanceDeleteRuleView,
    AttendanceDownloadView,
    AttendanceEditCodeView,
...
from dst.jc_views import (
    add_charge,
    add_case_reference,
    add_charge_reference,
    continue_case,
    create_case,
    delete_case,
    delete_charge,
    download_charges,
    download_meeting_rps,
    edit_meeting,
    edit_resolution_plan_list,
    edit_school_meeting_decision,
    edit_today,
    enter_school_meeting,
    get_case_references_json,
    get_last_rp,
    jc_index,
    legacy_person_history,
    legacy_person_rule_history,
    legacy_rule_history,
    print_meeting,
    print_weekly_minutes,
    remove_case_reference,
    remove_charge_reference,
    save_case,
    save_charge,
    set_rp_complete,
    this_week_report,
...
urlpatterns = [
    ...
    path("setResolutionPlanComplete", set_rp_complete),
    path("getLastRp/<int:person_id>/<int:rule_id>", get_last_rp),
    path("getCaseReferencesJson/<int:case_id>", get_case_references_json),
    path("addReferencedCase/<int:case_id>", add_case_reference),
    path("removeReferencedCase/<int:case_id>", remove_case_reference),
    path("addChargeReferenceToCase/<int:case_id>", add_charge_reference),
    path("removeChargeReferenceFromCase/<int:case_id>", remove_charge_reference),
    path("viewWeeklyReport", view_weekly_report),
    path("printWeeklyMinutes/<str:start_date>", print_weekly_minutes),
    path("viewSimpleResolutionPlans", view_simple_rps),
    path("personRuleHistory/<int:person_id>/<int:rule_id>", legacy_person_rule_history),
    path("personHistory/<int:person_id>", legacy_person_history),
    path("ruleHistory/<int:rule_id>", legacy_rule_history),
    path("downloadMeetingResolutionPlans/<int:meeting_id>", download_meeting_rps),
    # Custodia routes
    ...
    path("attendance/checkin", AttendanceCheckinView.as_view()),
    path("attendance/checkin/data", AttendanceCheckinDataView.as_view()),
    path("attendance/editCode/<int:code_id>", AttendanceEditCodeView.as_view()),
    path("attendance/saveCode", lambda r: redirect("/attendance/codes")),
    path("attendance/createPersonWeek", AttendanceCreatePersonWeekView.as_view()),
    path("attendance/deletePersonWeek", AttendanceDeletePersonWeekView.as_view()),
    path("attendance/saveOffCampusTime", AttendanceSaveOffCampusView.as_view()),
    ...
    path("settings/", settings_index),
    path("settings/notifications", settings_notifications),
    path("settings/password", settings_password),
    path("settings/access", settings_access),
    path("settings/access/editUser/<int:user_id>", settings_edit_user),
    path("settings/checklists", settings_view),
    path("settings/checklist/<int:checklist_id>", settings_checklist),
    path("settings/task/<int:task_id>", settings_task),
    ...
    path("getTagMembers", get_tag_members),
    path("downloadTag/<int:tag_id>", download_tag),
    path("addPeopleFromTag", add_people_from_tag),
    path("addPeopleToTag", add_people_to_tag),
    path("removePeopleFromTag", remove_people_from_tag),
    path("undoTagChanges", undo_tag_changes),
    ...
    path("roles/updateRole/<int:role_id>", roles_update),
    path("roles/deleteRole/<int:role_id>", roles_delete),
]
