...
class OrgConfig:
    def __init__(self, name):
        ...
        self.name = name
        self.people_url = ""
        self.str_manual_title = "Manual"
        self.str_manual_title_short = "Manual"
        self.str_res_plan_short = "RP"
        self.str_res_plan = "resolution plan"
        self.str_res_plan_cap = "Resolution Plan"
        self.str_res_plans = "resolution plans"
        self.str_res_plans_cap = "Resolution Plans"
